...
return array(
    'AbstractApprover' => $baseDir . '/services/pipeline/ApprovalWorkflowService.php',
    'ApplicationModel' => $baseDir . '/models/ApplicationModel.php',
    'ApprovalWorkflowService' => $baseDir . '/services/pipeline/ApprovalWorkflowService.php',
    'ApproverHandler' => $baseDir . '/services/pipeline/ApprovalWorkflowService.php',
    'AssessmentModel' => $baseDir . '/models/AssessmentModel.php',
    'AuditLogger' => $baseDir . '/core/AuditLogger.php',
    'AuditModel' => $baseDir . '/models/AuditModel.php',
    'AuditTrailService' => $baseDir . '/services/admin/AuditTrailService.php',
    'AvailabilityResolverService' => $baseDir . '/services/interviewer/AvailabilityResolverService.php',
    'BackgroundCheckService' => $baseDir . '/services/offer/BackgroundCheckService.php',
    'BaseController' => $baseDir . '/core/BaseController.php',
    'BaseModel' => $baseDir . '/core/BaseModel.php',
    'BriefingGeneratorService' => $baseDir . '/services/interviewer/BriefingGeneratorService.php',
    'CandidateModel' => $baseDir . '/models/CandidateModel.php',
    'CodeValidatorInterface' => $baseDir . '/services/assessment/CodeValidatorService.php',
    'CodeValidatorService' => $baseDir . '/services/assessment/CodeValidatorService.php',
    'CompetencyGapService' => $baseDir . '/services/feedback/CompetencyGapService.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'ConsensusService' => $baseDir . '/services/feedback/ConsensusService.php',
    'CooldownException' => $baseDir . '/services/assessment/CooldownService.php',
    'CooldownService' => $baseDir . '/services/assessment/CooldownService.php',
    'DataRetentionService' => $baseDir . '/services/admin/DataRetentionService.php',
    'Database' => $baseDir . '/core/Database.php',
    'DatabaseIntegrityService' => $baseDir . '/services/admin/DatabaseIntegrityService.php',
    'DeduplicationService' => $baseDir . '/services/pipeline/DeduplicationService.php',
    ...
    'DepartmentHeadApprover' => $baseDir . '/services/pipeline/ApprovalWorkflowService.php',
    'DifficultyAdjustmentService' => $baseDir . '/services/assessment/DifficultyAdjustmentService.php',
    'DiversityReportService' => $baseDir . '/services/admin/DiversityReportService.php',
    'DuplicateResult' => $baseDir . '/services/pipeline/DeduplicationService.php',
    'EmailService' => $baseDir . '/core/EmailService.php',
    'EventBus' => $baseDir . '/core/EventBus.php',
    'FeedbackAggregatorService' => $baseDir . '/services/feedback/FeedbackAggregatorService.php',
    'FeedbackModel' => $baseDir . '/models/FeedbackModel.php',
    'FinanceApprover' => $baseDir . '/services/pipeline/ApprovalWorkflowService.php',
    'GlassdoorAdapter' => $baseDir . '/services/pipeline/JobBoardSyncService.php',
    'HRDirectorApprover' => $baseDir . '/services/pipeline/ApprovalWorkflowService.php',
    'HiringRecommendationService' => $baseDir . '/services/feedback/HiringRecommendationService.php',
    'IndeedAdapter' => $baseDir . '/services/pipeline/JobBoardSyncService.php',
    'InterviewModel' => $baseDir . '/models/InterviewModel.php',
    'JavaScriptValidator' => $baseDir . '/services/assessment/CodeValidatorService.php',
    'JobBoardAdapterInterface' => $baseDir . '/services/pipeline/JobBoardSyncService.php',
    'JobBoardSyncService' => $baseDir . '/services/pipeline/JobBoardSyncService.php',
    'JobRequisitionModel' => $baseDir . '/models/JobRequisitionModel.php',
    'LinkedInAdapter' => $baseDir . '/services/pipeline/JobBoardSyncService.php',
    'LiveCodingSyncService' => $baseDir . '/services/interviewer/LiveCodingSyncService.php',
    'LoadBalancerService' => $baseDir . '/services/interviewer/LoadBalancerService.php',
    'NegotiationTrackerService' => $baseDir . '/services/offer/NegotiationTrackerService.php',
    'NormalizedScoringStrategy' => $baseDir . '/services/pipeline/SkillWeightingService.php',
    'NotificationEscalatorService' => $baseDir . '/services/admin/NotificationEscalatorService.php',
    'NotificationModel' => $baseDir . '/models/NotificationModel.php',
    'OfferCalculatorService' => $baseDir . '/services/offer/OfferCalculatorService.php',
    'OfferLetterService' => $baseDir . '/services/offer/OfferLetterService.php',
    'OfferModel' => $baseDir . '/models/OfferModel.php',
    'OfferValidityService' => $baseDir . '/services/offer/OfferValidityService.php',
    'OnboardingPortalService' => $baseDir . '/services/offer/OnboardingPortalService.php',
    ...
    'PanelBuilderService' => $baseDir . '/services/interviewer/PanelBuilderService.php',
    'PanelValidationException' => $baseDir . '/services/interviewer/PanelBuilderService.php',
    'PdfGeneratorService' => $baseDir . '/services/offer/PdfGeneratorService.php',
    ...
    'PhpValidator' => $baseDir . '/services/assessment/CodeValidatorService.php',
    'PlagiarismService' => $baseDir . '/services/assessment/PlagiarismService.php',
    'ProctoringService' => $baseDir . '/services/assessment/ProctoringService.php',
    'PythonValidator' => $baseDir . '/services/assessment/CodeValidatorService.php',
    'QuestionBankService' => $baseDir . '/services/assessment/QuestionBankService.php',
    'QuestionModel' => $baseDir . '/models/QuestionModel.php',
    'RBACMiddleware' => $baseDir . '/core/RBACMiddleware.php',
    'RBACService' => $baseDir . '/services/admin/RBACService.php',
    'RedFlagService' => $baseDir . '/services/feedback/RedFlagService.php',
    'ReferralService' => $baseDir . '/services/offer/ReferralService.php',
    'Router' => $baseDir . '/core/Router.php',
    'ScoreNormalizationService' => $baseDir . '/services/feedback/ScoreNormalizationService.php',
    'ScoringStrategyInterface' => $baseDir . '/services/pipeline/SkillWeightingService.php',
    'ScreeningTriageService' => $baseDir . '/services/pipeline/ScreeningTriageService.php',
    ...
    'SentimentLoggerService' => $baseDir . '/services/feedback/SentimentLoggerService.php',
    'SessionExtensionService' => $baseDir . '/services/interviewer/SessionExtensionService.php',
    'SessionHeartbeatService' => $baseDir . '/services/assessment/SessionHeartbeatService.php',
    'ShadowingService' => $baseDir . '/services/interviewer/ShadowingService.php',
    'ShortlistingService' => $baseDir . '/services/pipeline/ShortlistingService.php',
    'SkillWeightingService' => $baseDir . '/services/pipeline/SkillWeightingService.php',
    'StateMachine' => $baseDir . '/core/StateMachine.php',
    'TemplateVersioningService' => $baseDir . '/services/admin/TemplateVersioningService.php',
    ...
    'ThroughputAnalyticsService' => $baseDir . '/services/pipeline/ThroughputAnalyticsService.php',
    'UserModel' => $baseDir . '/models/UserModel.php',
    'WeightedAverageStrategy' => $baseDir . '/services/pipeline/SkillWeightingService.php',
